...
resampleShortDocuments = True #whether to resample documents that are shorter than maxLen up to the maximum length.  This could be helpful if short documents are getting swamped by the noise

#JF: This function is used to enforce that all documents are less than the maximumspecified length, taking into account the vocabulary
