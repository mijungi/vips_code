...
if  __name__ =='__main__':
    ...
    for iter in range(MaxIter):
        ...
        exp_suff_stats1, exp_suff_stats2 = VIPS_BLR.VBEstep_private(eps_iter, delta_iter, xtrain_m, ytrain_m, exp_nat_params_prv, N)

        if iter==0:
            nu_old = []
            ab_old = []
        nu_new, ab_new, exp_nat_params, mean_alpha, Mu_theta = VIPS_BLR.VBMstep_stochastic(rhot, nu_old, ab_old, N, a0, b0, exp_suff_stats1, exp_suff_stats2, mean_alpha_prv, iter)
